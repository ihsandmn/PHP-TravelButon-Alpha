        ...
        <main>
            <section class="abuabu" id="blog">
                <div class="layar-dalam">
                    ...
                    <div class="blog">
                        <div class="area">
                            <div class="gambar" style="background-image: url('asset/makanan1.jpg');"></div>
                            <div class="text">
                                <article>
                                    <h4><a href="makanankhas1.php">Parende</a>
                                    </h4>
                                    <p>Olahan Ikan yang dimasak dengan kuah kuning.
                                    </p>
                                </article>
                            </div>
                        </div>
                        <div class="area">
                            <div class="gambar" style="background-image: url('asset/makanan2.jpg');"></div>
                            <div class="text">
                                <article>
                                    <h4><a href="makanankhas2.php">Tuli-Tuli</a>
                                    </h4>
                                    <p>Makanan yang terbuat dari parutan kelapa.
                                    </p>
                                </article>
                            </div>
                        </div>
